...
public class MeetingAdapter extends RecyclerView.Adapter<MeetingAdapter.MeetingHolder> {
    ...
    private ArrayList<PochameetingData> meetList = new ArrayList<>();

    private Context context;
    private DatabaseReference databaseReference;
    private FirebaseDatabase firebaseDatabase;

    public MeetingAdapter(ArrayList<PochameetingData> meetList, Context context) {
        this.meetList.clear();
    ...
    public void onBindViewHolder(@NonNull MeetingAdapter.MeetingHolder holder, int position){
        ...
        holder.meeting_yeardate.setText(meetList.get(position).getYearDate() + " / "+ meetList.get(position).getRegisterTime());

        PochameetingData pochameetingData = meetList.get(position);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, MeetingDetailData.class);
